...
GRANT EXECUTE ON PROCEDURE merchanmanager.consulta_pedido_por_estado TO 'admin'@'%';
...
GRANT EXECUTE ON PROCEDURE merchanmanager.consulta_pedido_por_estado TO 'ventas'@'%';
